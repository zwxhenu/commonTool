...
class RequestCore {
	...
	/**
	 * Sets cookie file for the class.
	 *
	 * @param string $cookie_file (Required) The unique filename string to use.
	 * @return $this A reference to the current instance.
	 */
	...
	/**
	 * Sets cookie jar file for the class.
	 *
	 * @param string $cookie_jar (Required) The unique filename string to use.
	 * @return $this A reference to the current instance.
	 */
	public function set_cookie_jar($cookie_jar) {
	...
	public function prep_request() {
		...
		if(isset($this->cookie_jar)){
			curl_setopt ( $curl_handle, CURLOPT_COOKIEJAR, $this->cookie_jar );
		}
